 ...
 * @Version 1.0
 */
public class RandomTimeTextFieldChangeHandler implements ChangeListener<String> {

    private TextField textField;


    public RandomTimeTextFieldChangeHandler(TextField textField) {
    ...
    public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        if (controller!=null)
        {
            ...
            randForceTxtData.setTime(newValue);
