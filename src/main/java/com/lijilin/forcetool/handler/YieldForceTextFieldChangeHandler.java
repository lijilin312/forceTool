 ...
 * @Version 1.0
 */
public class YieldForceTextFieldChangeHandler implements ChangeListener<String> {

    private TextField textField;


    public YieldForceTextFieldChangeHandler(TextField textField) {
    ...
    public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        if (controller!=null)
        {
            ...
            randForceTxtData.setYieldForce(newValue);
