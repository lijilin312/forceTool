 ...
 * @Version 1.0
 */
public class UidTextFieldChangeHandler implements ChangeListener<String> {

    private TextField textField;


    public UidTextFieldChangeHandler(TextField textField) {
    ...
    public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        if (controller!=null)
        {
            ...
            randForceTxtData.setUid(newValue);
