 ...
 * @Version 1.0
 */
public class TestCountTextFieldChangeHandler implements ChangeListener<String> {

    private TextField textField;


    public TestCountTextFieldChangeHandler(TextField textField) {
    ...
    public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
        ...
        if (controller!=null)
        {
            ...
            if (newValue.equals(""))
            {
                randForceTxtData.setTestCount(0);
            }else {
                randForceTxtData.setTestCount(Integer.parseInt(newValue));
            }
